...
export default function User() {
  ...
  return (
    ...
    <Container>
      ...
      <TextField id="outlined-basic" style={boxStyle} label="이름" variant="outlined" fullWidth
      value={userName} 
      onChange={(e)=>SetUserName(e.target.value)}/>

      <TextField id="outlined-basic" style={boxStyle} label="이메일" variant="outlined" fullWidth
      value={userEmail} 
